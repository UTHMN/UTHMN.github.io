import { DebugImage, Envelope, Event } from '@sentry/types';
import { Profile, ThreadCpuProfile } from '@sentry/types/src/profiling';
import { JSSelfProfile } from './jsSelfProfiling';
/**
 *
 */
 ...
 */
export declare function createProfilePayload(event: ProfiledEvent, processedProfile: JSSelfProfile, profile_id: string): Profile;
/**
 *
 */
 ...
 */
export declare function createProfilingEvent(profile_id: string, profile: JSSelfProfile, event: ProfiledEvent): Profile | null;
export declare const PROFILE_MAP: Map<string, JSSelfProfile>;
/**
 *
 */
export declare function addProfileToMap(profile_id: string, profile: JSSelfProfile): void;
